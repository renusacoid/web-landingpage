        ...
        <div className="flex w-full pl-4 md:pl-[18.75rem] pt-24 gap-x-4 md:gap-x-24">
          <div className="">
            ...
            <div className="flex flex-col gap-y-10 pt-6 pl-6">
              <p>Penerimaan Ketentuan</p>
              <p>Penggunaan Layanan</p>
              <p>Hak Kekayaan Intelektual</p>
              <p>Penghentian</p>
              <p>Pembatasan Tanggung Jawab</p>
              <p>Perubahan Ketentuan</p>
              <p>Kontak</p>
            </div>
          </div>
          ...
          <div className="justify-self-start flex flex-col gap-y-10 w-8/12 text-justify pr-4 md:pr-32">
            ...
            <div>
              <h1 className="font-bold text-lg">Penerimaan Ketentuan</h1>
              <p>
            ...
            <div>
              <h1 className="font-bold text-lg">Penggunaan Layanan</h1>
              <p>
            ...
            <div>
              <h1 className="font-bold text-lg">Hak Kekayaan Intelektual</h1>
              <p>
            ...
            <div>
              <h1 className="font-bold text-lg">Penghentian</h1>
              <p>
            ...
            <div>
              <h1 className="font-bold text-lg">Pembatasan Tanggung Jawab</h1>
              <p>
            ...
            <div>
              <h1 className="font-bold text-lg">Perubahan Ketentuan</h1>
              <p>
