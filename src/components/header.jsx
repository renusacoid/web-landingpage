...
const Header = () => {
  return (
    <header className="bg-[url('/assets/bg-hero.png')] h-full md:h-screen  bg-cover bg-fixed bg-no-repeat">
      <Nav />
      ...
      <div className="flex flex-col md:flex-row h-[80vh] justify-center items-center gap-x-[15vh]">
        <div className="">
          <h1 className="text-white text-[3rem] md:text-[4rem] lg:text-[5rem] xl:text-[6rem] font-bold">
            Introduce <br />
            Wisnu.
          </h1>
          <p className="text-white font-semibold sm:text-base md:text-lg lg:text-xl xl:text-2xl">
