...
const TopTrip = () => {
  ...
  return (
    <section className="relative overflow-x-auto">
      ...
      <div>
        <h1 className="text-center sm:text-left font-bold text-6xl mb-14 bg-custom-gradient text-transparent bg-clip-text inline-block pb-3 pl-3 md:pl-40 pt-[15vh] md:pt-[50vh]">
          “Our Top Trip
          <br />
          {/* &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Category” */}
          <span className="md:ml-[22vh]">Category”</span>
        </h1>
      </div>
      <div
        className="flex overflow-x-scroll pl-0 md:pl-40"
                ...
                >
                  <div className="flex items-center justify-center gap-x-4">
                    <Image
                      ...
                      width={35}
                    />
                    <h1 className="montserrat">{titles[index]}</h1>
                  </div>
                </div>
              </div>
            </div>
